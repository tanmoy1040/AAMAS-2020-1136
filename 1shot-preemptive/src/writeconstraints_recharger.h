...
void writeMatchingConstraints_rechargers (ofstream &, workspace_t , worker_vec_t );
void minimizeWaiting_rechargers (ofstream &, workspace_t, worker_vec_t, prim_vec_t);
